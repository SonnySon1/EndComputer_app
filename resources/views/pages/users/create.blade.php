                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form" action="{{ route('users.store') }}" method="POST" id="form-add-user">
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" name="address" id="address" class="form-control" placeholder="ex : JL. Jendral Sudirman, No. 1, Bandung">
                                            </div>
                                            <div class="form-group mb-3">
                                                <label for="phonenumber">Phone Number</label>
                                                <input type="tel" name="phonenumber" id="phonenumber" class="form-control" placeholder="ex : 08000000000">
                                            </div>
                                            <div class="form-group mb-3">
                                                <label for="email">Email</label>
                                                <input type="email" name="email" id="email" class="form-control" placeholder="ex : johndoe@example.com">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                             <div class="form-group mb-3">
